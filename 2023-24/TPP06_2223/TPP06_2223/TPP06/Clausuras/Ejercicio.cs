...
namespace Clausuras
{
    public static class Ejercicio
    {
        ...
        public int ClausuraAleatorio()
        {
            Action<int> ObtenerValor;
            Func<int> Valor;
            Random random= new Random();
            int numero = random.Next(0, Valor);
            ObtenerValor = numero;
            return numero;
        }
        ...
        public static void main()
        {
            Action<int> SetValor;
            Func<int> ClausuraA;
            ClausuraAleatorio.ObtenerValor(7, out SetValor, out ClausuraA);
            Console.WriteLine($"[Clausulas] Almacenado: {ClausuraA()}");
        }

        public static int ClausuraA(int valor)
        {
            Random random = new Random();
            return random.Next(0, valor);
        }
